...
try:
    ...
    print('[v0] Committing...')
    subprocess.run(['git', 'commit', '-m', 'feat: Complete admin dashboard with all 11 pages, responsive design, hydration fix, and full dark/light mode support'], check=True)
